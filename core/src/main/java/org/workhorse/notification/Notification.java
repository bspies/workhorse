 ...
 *
 * <p>Service interface for user notifications.</p>
 */
public interface Notification extends Service
{
    /**
	 * Sends the notice using the default {@link Notifier}.
    ...
    /**
     * Returns a collection of notifiers available in this service.
     * @return The service's notifiers
     */
